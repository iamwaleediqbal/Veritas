...
const Dashboard = () => {
    ...
    const fetchBooks = async()=>{
        ...
        const data = await response.get().then(querySnapshot => { querySnapshot.forEach(data =>{
    ...
    const fetchImage = () => {
        try{
            ...
            const data = photos.child(`books/covers/`).listAll().then(url => {url.items.forEach(igurl =>{
                igurl.getDownloadURL().then(imgURL => setPhotourl(b => [...b,imgURL]))
            })})
            return data;
        }catch(error){
            console.log(error);
    ...
    const handleDelete = async(b,s) =>{
        ...
        photos.child(`${s}/ebooks/${s.includes("books")? b.book_url:b.mag_url}`).delete();
            ...
            <ul className = "Books" id = "Books">
                ...
                return(
                    ...
                    <li key ={index}>
                        ...
                        <figure>
                            <img src = {photoURL}  alt="Book"width = "350vh" height ="400vh" />
                            <figcaption>
                                <header>
                                    <h3>{books.title} </h3>
                                    <p overflow = "hidden"><strong>{books.authors + " "}</strong></p>
                                </header>
                                <p>{books.synopsis.substring(0,200)}</p>
                                <div className="actions" >
                                    <ul id = "actions0">
                                        <li >
                                        <img src = {"/Assets/delico.png"} width = "16px" height = "16px" margin = "0" />
                                            <a href="#" target="_blank" data-toggle="blog-tags" onClick = {() => handleDelete(books,"books")}>
                                                Delete
                                            </a>
                                        </li>
                                        <li >
                                            <img src = {"/Assets/edico.png" }width = "16px" height = "16px"/>
                                        
                                            <a href = "/editbook" onClick ={() => handleEdit(books)}  >
                                                EDIT
                                            </a>
                                        </li>
                                    </ul>
    ...
    const magazineDisplay = () =>{
        ...
        <div className="booksmedia-fullwidth">
            <ul className = "Magazines" id = "Magazines">
                ...
                {mag.filter(books => books.publisher.includes(currentUser.displayName)).filter(books => search === '' ? books:books.title.toLowerCase().includes(search)).map((books,index)=>{
                    const photoURL = magphotourl.filter((e) => e.includes(books.photo_url));
                    console.log(photoURL + "   " + books.photo_url);
                return(
                    ...
                    <li key ={index}>
                        ...
                        <figure>
                            ...
                            <figcaption>
                                <header>
                                    <h3>{books.title} </h3>
                                    <p overflow = "hidden"><strong>{"Published Date: " + books.issue_date}</strong></p>
                                </header>
                                ...
                                <div className="actions" >
                                    <ul id = "actions0">
                                        <li >
                                        <img src = {"/Assets/delico.png"} width = "16px" height = "16px" margin = "0" />
                                            <a href="#" target="_blank" data-toggle="blog-tags" onClick = {() => handleDelete(books,"magazines")}>
                                                Delete
                                            </a>
                                        </li>
                                        <li >
                                            ...
                                            <a href = "/editmagazine" onClick ={() => handleEdit(books)}  >
                                                EDIT
                                            </a>
                                        </li>
                                    </ul>
 ...
 return (
    <div>
        ...
        <form className = "hupbtn" style = {{"margin-bottom" :"40px"}}>
            <button className = " upbtn" onClick = {() => hist.push('/bookupload')} style = {{"margin-right":"30px"}} >
                        ...
                        <div className="container">
                            <section className="search-filters">
                                <div className="filter-box">
									<h3 color = "#111B2B" display =  "block"  width =  "50%" >Welcome to your library</h3>
                                        <div className="col-md-4 col-sm-6">
                                            <div className="form-group">
                                                <input className="form-control" placeholder="Search by Keyword" id="keywords" name="keywords"
