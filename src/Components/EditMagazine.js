...
class EditMagazine extends React.Component {
  ...
  handleUpload = async (e) => {
    ...
    if (this.images.length === 1) {
      if (this.images[0].name.includes(".pdf"))
        fireBaseApp
          .storage()
          .ref(`magazines/ebooks/${this.images[0].name}`)
          .put(this.images[0]);
      else
        fireBaseApp
          .storage()
      ...
      .update({
        photo_url:
          this.images.length === 0
            ...
            ? this.images[0].name.includes(".pdf")
              ? this.state.photo_url
              : this.images[0].name
            : this.images[0].name,
        book_url:
  ...
  addMessage = (e) => {
    ...
    db.collection("magazines").doc(this.state.id).update({
      ...
      <div>
        ...
        <div className="bookbody">
          <h3 align="center" className="heading">
            Update Magazine {this.state.title}
          </h3>
          <div className="container" id="container">
            ...
            <div className="overlay-container uc">
              ...
              <form action="#">
                ...
                <input
                  type="file"
                  style={{ margin: "0px 20px 20px 50px" }}
                  name="Upload Image"
