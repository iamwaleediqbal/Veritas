          ...
          <nav className="u-menu u-menu-dropdown u-offcanvas u-menu-1">
            ...
            <div className="u-nav-container">
              <ul className="col-md-pull-1 u-nav u-unstyled u-nav-1">
                <li className={path == '/magazineupload' ? 'mnbtn u-nav-item' :"u-nav-item" }>
                  <a
                ...
                <li className={path == '/bookupload' ? 'mnbtn u-nav-item' :"u-nav-item" }>
                  <a
                    className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                    href="/bookupload"
                    style={{padding: "10px 20px"}}
                ...
                <div className="u-inner-container-layout u-sidenav-overflow">
                  ...
                  <ul className="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                    <li className="u-nav-item">
                      <a className="u-button-style u-nav-link" href="/magazineupload">
                        Upload a Magazine
                      </a>
                    </li>
                    <li className="u-nav-item">
                      <a className="u-button-style u-nav-link" href="/bookupload">
                        Upload a Book
                      </a>
                    </li>
                    <li className="u-nav-item">
                      <a className="u-button-style u-nav-link" onClick={logOutUser}>
                        Log Out
                      </a>
                    </li>
                  </ul>
