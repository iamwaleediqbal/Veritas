    ...
    render(){
        ...
        return(
            <div> 
               ...
               <h3 align = 'center' className = "heading" >Update Book {this.state.title}</h3>
                <div className="container" id="container">
                    <div className=" form-container log-in-container">
                        <form className = "bookForm"onSubmit={this.addMessage.bind(this)}><br/><br/>
                            <input className = "inputcat" value = {this.state.title} onChange={(e) => { this.setState({ title: e.target.value }) }} type="text" placeholder="Book Title" />
                            <br/>
                            <input className = "inputcat" type="text" value = {this.state.author} onChange={(e) => { this.setState({ author: e.target.value }) }} placeholder="Author1, Author2, ..." />
                            <br/>
                            <input className = "inputcat"type="text" value = {this.state.genre} onChange={(e) => { this.setState({ genre: e.target.value }) }} placeholder="Genre1, Genre2, ..." />
                            <br/>
                            <input className = "inputcat"type="text" value = {this.state.synopsis} onChange={(e) => { this.setState({ synopsis: e.target.value }) }} placeholder="Synopsis" />
                        </form>
                    </div>
